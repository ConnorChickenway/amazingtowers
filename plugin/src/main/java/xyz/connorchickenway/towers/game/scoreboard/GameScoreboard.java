...
public class GameScoreboard {
    ...
    private final Map<GamePlayer, FastBoard> scoreMap = Maps.newConcurrentMap();
    ...
    private static final ScoreboardManager scoreboardManager = AmazingTowers.getInstance().getScoreboardManager();
