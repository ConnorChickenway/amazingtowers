package xyz.connorchickenway.towers.game.lang.utils;
...
public class MessageUtils
{
    ...
    public enum DefaultFontInfo
    {
        ...
        RIGHT_PERENTHESIS( ')', 4 ), MINUS( '-', 5 ), UNDERSCORE( '_', 5 ), PLUS_SIGN( '+', 5 ), EQUALS_SIGN( '=', 5 ),
    ...
    public static String convert( String message )
    {
        ...
        message = message.replaceAll( Pattern.quote( "{center}" ), "" );
